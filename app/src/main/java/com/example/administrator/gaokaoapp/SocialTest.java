...
public class SocialTest extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        answer = new char[20];
        final String[] arr_text1 = res.getStringArray(R.array.text1);
        final String[] arr_text1_a = res.getStringArray(R.array.text1_a);
        final String[] arr_text1_b = res.getStringArray(R.array.text1_b);
        final String[] arr_text1_c = res.getStringArray(R.array.text1_c);
        ...
        eachProgress = Math.round(lpParent.width / 20);
        ...
        btn_next.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                if (i==19){
                    Intent i = new Intent(SocialTest.this, AllResult.class);
                    i.putExtra("answer-social", answer);
                    startActivity(i);
                }
...
//                }
        ...
        btn_back.setOnClickListener( new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent( SocialTest.this, main.class );
